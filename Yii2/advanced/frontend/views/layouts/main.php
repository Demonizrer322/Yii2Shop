...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?=Url::toRoute('site/shop')?>">Shop</a>
      </li>
      <li class="nav-item active">
    ...
    ?>
      <li class="nav-item active">
        <a class="nav-link" href="<?=Url::toRoute('site/signup')?>">SingUp</a>
      </li>
      <li class="nav-item active">
    ...
    ?>
      <li class="nav-item active">
        <a class="nav-link" href="<?=Url::toRoute('site/logout')?>">LogOut <?=Yii::$app->user->identity->username?></a>
      </li>
    <?php
    }
    ?>
